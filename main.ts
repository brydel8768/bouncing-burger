namespace SpriteKind {
    export const monl = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.monl, SpriteKind.Food, function (sprite, otherSprite) {
    game.over(true)
})
sprites.onOverlap(SpriteKind.monl, SpriteKind.Player, function (sprite, otherSprite) {
    game.over(false)
})
let barger = sprites.create(img`
    . . . . c c c b b b b b . . . . 
...
barger.vx = 60
barger.vy = 100
barger.setBounceOnWall(true)
let doggie = sprites.create(img`
    . . . . f f f f f . . . . . . . 
    . . . f e e e e e f . . . . . . 
    . . f d d d d e e e f . . . . . 
    ...
    . . . . f f f f f f f f f . . . 
    `, SpriteKind.monl)
doggie.setPosition(28, 85)
controller.moveSprite(doggie)
